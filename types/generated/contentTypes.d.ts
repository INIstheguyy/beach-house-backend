...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    agentCommission: Schema.Attribute.Integer;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    flutterwaveReference: Schema.Attribute.String;
    flutterwaveTransactionId: Schema.Attribute.String;
    guestEmail: Schema.Attribute.Email & Schema.Attribute.Required;
    guestName: Schema.Attribute.String & Schema.Attribute.Required;
    guestPhone: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
    ...
    numberOfNights: Schema.Attribute.Integer & Schema.Attribute.Required;
    ...
    property_owner: Schema.Attribute.Relation<
      'manyToOne',
      'api::property-owner.property-owner'
    >;
    propertyOwnerAmount: Schema.Attribute.BigInteger;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPropertyOwnerPropertyOwner
  extends Struct.CollectionTypeSchema {
  collectionName: 'property_owners';
  info: {
    displayName: 'PropertyOwner ';
    pluralName: 'property-owners';
    singularName: 'property-owner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    flutterwaveSubaccount: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::property-owner.property-owner'
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    flutterwaveSubaccount: Schema.Attribute.String;
    icalUrl: Schema.Attribute.String;
    isActive: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    propertyType: Schema.Attribute.Enumeration<
      ['Beach House', 'Apartment', 'Other-Services']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    agentCommissionDefault: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<20>;
    agentFlutterwaveAccount: Schema.Attribute.String;
    contactEmail: Schema.Attribute.Email;
    contactPhone: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    flutterwavePublicKey: Schema.Attribute.String;
    flutterwaveSecretKey: Schema.Attribute.String;
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Lagos Beach Rentals'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::property-owner.property-owner': ApiPropertyOwnerPropertyOwner;
